...
def init():
    ...
    if r == 2:
        ...
        actors = ['2_1.png','2_1.png','2_1.png','2_1.png','2_1.png','2_1.png',
                  '2_2.png','2_2.png','2_2.png','2_2.png','2_2.png','2_2.png',
                  '2_3.png','2_3.png','2_3.png','2_3.png','2_3.png','2_3.png',
                  '2_4.png','2_4.png','2_4.png','2_4.png','2_4.png','2_4.png',
                  '2_5.png','2_5.png','2_5.png','2_5.png','2_5.png','2_5.png',
                  '2_1.png','2_1.png','2_1.png','2_3.png','2_3.png','2_3.png',]
        random.shuffle(actors)
        for i in range(18):
            ...
            cards.append(card)
        for i in range(18):
            card = Actor(actors[i + 18], (65+120 * (i % 6 + 1), 160 * (i // 6 + 1)))
            card.p = 1
            card.level = 3
            cards.append(card)
    if r == 3:
        #更换第3关卡牌，每张卡牌的出现次数需要是3的倍数！
        actors = ['3_1.png','3_1.png','3_1.png','3_1.png','3_1.png','3_1.png',
                  '3_2.png','3_2.png','3_2.png','3_3.png','3_3.png','3_3.png',
                  '3_3.png','3_3.png','3_3.png','3_4.png','3_4.png','3_4.png',
                  '3_5.png','3_5.png','3_5.png','3_5.png','3_5.png','3_5.png',
                  '3_6.png','3_6.png','3_6.png','3_6.png','3_6.png','3_6.png',
                  '3_7.png','3_7.png','3_7.png','3_8.png','3_8.png','3_8.png']
        random.shuffle(actors)
        x = 0
        for i in range(5):
        ...
        for i in range(10):
            ...
            x+=1
    if r==4:
        actors = ['1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
                  '1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
                  '1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
                  '1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
                  '1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
                  '1_1.png','1_1.png','1_1.png','1_1.png','1_1.png','1_1.png',
